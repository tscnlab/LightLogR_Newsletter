...
function buildSkyScene() {
  ...
  const flareSpecs = [
    { distance: 0.3, size: 18, hue: 45, opacity: 0.35, phase: 0.0 },
    { distance: 0.55, size: 26, hue: 190, opacity: 0.25, phase: 1.7 },
    { distance: 0.8, size: 34, hue: 310, opacity: 0.18, phase: 3.1 }
  ];
